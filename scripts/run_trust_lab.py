...
<main id="main">
  ...
  <section id="schemas"><div class="section-head"><div><p class="eyebrow">Integration contract</p><h2>Versioned JSON schemas</h2></div><p>Schema v1 remains stable within its major version. Additive or breaking changes publish a new path instead of silently changing existing consumers.</p></div><div class="contract-grid"><article class="contract"><h3>CLI reports</h3><ul><li><a href="trust-lab/schemas/v1/redaction-verification.schema.json">redaction verification</a></li><li><a href="trust-lab/schemas/v1/privacy-inspection.schema.json">privacy inspection</a></li><li><a href="trust-lab/schemas/v1/change-review.schema.json">change review</a></li><li><a href="trust-lab/schemas/v1/capabilities.schema.json">runtime capabilities</a></li></ul></article><article class="contract"><h3>Corpus and release data</h3><ul><li><a href="trust-lab/schemas/v1/corpus-manifest.schema.json">corpus manifest</a></li><li><a href="trust-lab/schemas/v1/trust-lab-results.schema.json">release results</a></li><li><a href="trust-lab/results/{html.escape(report['release_version'])}.json">current machine-readable result</a></li></ul></article></div></section>
