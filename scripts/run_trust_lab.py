...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    @media(max-width:560px) {{ header {{ align-items:center; gap:.65rem; padding:.7rem 1rem; }} .brand {{ flex:0 0 auto; }} .brand>span:last-child {{ display:none; }} nav {{ flex:1; flex-wrap:nowrap; justify-content:flex-start; gap:.2rem; overflow-x:auto; overscroll-behavior-inline:contain; scrollbar-width:none; }} nav a {{ display:flex; align-items:center; flex:0 0 auto; min-height:44px; padding:0 .5rem; }} .hero {{ gap:2rem; padding:3rem 0 2.5rem; }} .hero-proof {{ padding:1.25rem; border-radius:1.3rem; }} section {{ padding:3rem 0; }} .case-grid {{ grid-template-columns:1fr; }} .section-head {{ display:block; }} h1 {{ font-size:clamp(3.1rem,16vw,3.6rem); }} }}
...
<main id="main">
  ...
  <section id="schemas"><div class="section-head"><div><p class="eyebrow">Integration contract</p><h2>Versioned JSON schemas</h2></div><p>Schema v1 remains stable within its major version. Additive or breaking changes publish a new path instead of silently changing existing consumers.</p></div><div class="contract-grid"><article class="contract"><h3>CLI reports</h3><ul><li><a href="trust-lab/schemas/v1/redaction-verification.schema.json">redaction verification</a></li><li><a href="trust-lab/schemas/v1/privacy-inspection.schema.json">privacy inspection</a></li><li><a href="trust-lab/schemas/v1/accessibility-inspection.schema.json">accessibility inspection</a></li><li><a href="trust-lab/schemas/v1/experimental-content-edit.schema.json">experimental content edit</a></li><li><a href="trust-lab/schemas/v1/change-review.schema.json">change review</a></li><li><a href="trust-lab/schemas/v1/capabilities.schema.json">runtime capabilities</a></li></ul></article><article class="contract"><h3>Corpus and release data</h3><ul><li><a href="trust-lab/schemas/v1/corpus-manifest.schema.json">corpus manifest</a></li><li><a href="trust-lab/schemas/v1/trust-lab-results.schema.json">release results</a></li><li><a href="trust-lab/results/{html.escape(report['release_version'])}.json">current machine-readable result</a></li></ul></article></div></section>
